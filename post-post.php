<article class="post-entry">
    <div class="post-wrapper">
        ...
        <section class="post-content">
            ...
            <?php the_content('<b class="label label-info more-link">more &raquo;</b>'); ?>
            <div class="meta selective-hide">
                <p><span>Filed Under: </span><b class="label label-warning"><?php the_category('</b><b class="label label-warning">') ?></b> <span>By: </span><a href="#"><?php the_author(); ?></a></p>
            </div>
